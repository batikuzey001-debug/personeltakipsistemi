...
// ✅ Zip’e göre mevcut uç: GET /report/daily
const PATH = "/report/daily";
  ...
  return (
    <div>
      <div style={{ display:"flex", gap:8, alignItems:"center", marginBottom:8 }}>
        ...
        <div style={{ flex:1 }} />
        <ExportCSVButton filename={`livechat-daily_${from}_${to}`} rows={rows} />
      </div>
      ...
      <div style={{ display:"flex", gap:8, alignItems:"center", margin:"8px 0 12px" }}>
        ...
        <select value={order} onChange={(e)=>set({ order: e.target.value, offset:0 })}
          ...
          <option value="-online_sec">Online (azalan)</option>
          <option value="online_sec">Online (artan)</option>
...
function navBtn(disabled:boolean): React.CSSProperties {
  return { padding:"6px 10px", border:"1px solid #ddd", borderRadius:8, background: disabled ? "#f1f1f1" : "#f7f7f7", cursor: "pointer" };
}
